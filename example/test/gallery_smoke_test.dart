...
void main() {
  ...
  group('gallery smoke', () {
    ...
    testWidgets('shows the key gallery sections and the selection readout', (
      ...
      expect(
        findTextContaining('ที่อยู่ปัจจุบัน'),
        findsWidgets,
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        expect(
          findTextContaining(bangkok.nameTh),
          findsWidgets,
          reason:
